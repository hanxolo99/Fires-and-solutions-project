...
if (! class_exists ( 'DTPortfolioPostType' )) {
	class DTPortfolioPostType {
		...
		function createPostType() {
			...
			$portslug = vigil_cs_get_option( 'single-portfolio-slug', 'dt_portfolios' );
			$taxslug = vigil_cs_get_option( 'portfolio-category-slug', 'portfolio_entries' );
				...
				array(
				  ...
				  'fields' => array(
					...
					array(
					  ...
					  'options'      => array(
						'full-width-portfolio'   => VIGIL_THEME_URI . '/cs-framework-override/images/portfolio-fullwidth.png',
						'with-left-portfolio'    => VIGIL_THEME_URI . '/cs-framework-override/images/portfolio-with-left-gallery.png',
						'with-right-portfolio'   => VIGIL_THEME_URI . '/cs-framework-override/images/portfolio-with-right-gallery.png',
					  ),
