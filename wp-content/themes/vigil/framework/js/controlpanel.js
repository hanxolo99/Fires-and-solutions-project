...
$color = ["blue","green","orange","pink","tequila","wild-watermelon","yellow"];
$colors = "";
...
jQuery(document).ready(function($){
	...
	if($.cookie("vigil_skin")!= null){
		var $href = dttheme_urls.theme_base_url + '/css/skins/' + $.cookie("vigil_skin")+"/style.css";
		$("link[id='skin-css']").attr("href",$href);
		$("ul.color-picker a[id='"+$.cookie("vigil_skin")+"']").addClass("selected");
	}else{
		$("ul.color-picker a:first").addClass("selected");
	}

	//Apply Layout
	if($.cookie("vigil_layout") == "boxed"){
		$("ul.layout-picker li a").removeAttr("class");
		$("ul.layout-picker li a[id='"+$.cookie("vigil_layout")+"']").addClass("selected");
		$("div#pattern-holder").removeAttr("style");

		$i = ($.cookie("vigil_pattern")) ? $.cookie("vigil_pattern")  : 'pattern1';
		...
		$("ul.pattern-picker a[id="+$.cookie("vigil_pattern")+"]").addClass('selected');
	} else if($.cookie("vigil_layout") == "fullwidth"){
		$("ul.layout-picker li a").removeAttr("class");
		$("ul.layout-picker li a[id='"+$.cookie("vigil_layout")+"']").addClass("selected");
		$("div#pattern-holder").removeAttr("style");
	...
	if($.cookie("vigil_scheme") != null){
		$("ul.scheme-picker li a").removeAttr("class");
		if( $.cookie("vigil_scheme") === "dark" ) {
		...
		else if( $.cookie("vigil_scheme") === "light" ) {
	...
	$("ul.layout-picker a").click(function(e){
		...
		$.cookie("vigil_layout", $this.attr("id"), { path: '/' });

		if( $.cookie("vigil_layout") === "boxed") {
			$("body").removeClass("layout-wide").addClass("layout-boxed");
			$("div#pattern-holder").slideDown();
			
			if( $.cookie("vigil_pattern") == null ){
				$("ul.pattern-picker a:first").addClass('selected');
				$.cookie("vigil_pattern","pattern1",{ path: '/' });
			}else{
				$("ul.pattern-picker a[id="+$.cookie("vigil_pattern")+"]").addClass('selected');
				$img = dttheme_urls.theme_base_url + "/images/patterns/"+$.cookie("vigil_pattern")+".jpg";
	...
	$("ul.scheme-picker a").click(function(e){
		...
		$this.addClass("selected");
		$.cookie("vigil_scheme", $this.attr("id"), { path: '/' });
		if( $.cookie("vigil_scheme") === "dark" ) {
			$("<link id='light-dark-css' href='"+ dttheme_urls.theme_base_url +"/dark/dark-skin.css' rel='stylesheet' media='all' />").insertBefore($('#skin-css'));
		}
		else if( $.cookie("vigil_scheme") === "light" ) {
	...
	$("ul.pattern-picker a").click(function(e){
		if($.cookie("vigil_layout") == "boxed"){
			...
			$("ul.pattern-picker a").removeAttr("class");
			$this.addClass("selected");
			$.cookie("vigil_pattern", $this.attr("id"), { path: '/' });
			$img = dttheme_urls.theme_base_url + "/images/patterns/"+$.cookie("vigil_pattern")+".jpg";
			$('body').css('background-image', 'url('+$img+')');
		}
		e.preventDefault();
	...
	$("ul.color-picker a").click(function(e){
		...
		$this.addClass("selected");
		$.cookie("vigil_skin", $this.attr("id"), { path: '/' });
