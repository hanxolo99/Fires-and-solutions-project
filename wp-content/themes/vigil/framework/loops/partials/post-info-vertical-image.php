<?php
			...
			<div class="entry-video-thumb"><?php
                ...
                <div class="entry-meta vertically-centered"><?php
                    ...
                    <div class="entry-info">
                        ...
                        <div class="views"><i class="zmdi zmdi-eye zmdi-hc-fw"> </i> <?php $vcount = isset( $post_meta['view_count'] ) ? $post_meta['view_count'] : 0; echo ($vcount);?> <?php esc_html_e('Views', 'vigil');?> </div>
                        <div class="likes dt_like_btn">
                            <i class="zmdi zmdi-favorite-outline zmdi-hc-fw"> </i>
                            <a href="#" data-postid="<?php the_ID(); ?>" data-action="like">
                                <i><?php echo vigil_post_functions::vigil_post_like_count($post->ID); ?></i>
                                <span><?php esc_html_e('Likes', 'vigil');?></span>
                            </a>
                        </div>
                    </div>
                </div><!-- .entry-meta -->
    ...
    <div class="entry-details">
      ...
      <!-- Share -->
      <?php if( vigil_is_plugin_active('designthemes-core-features/designthemes-core-features.php')  && class_exists( 'DTCorePlugin' ) ){ 
      			echo do_shortcode('[dt_sc_post_social_shared post_id="'.$post->ID.'" /]');
	  		} ?><!-- Share -->
