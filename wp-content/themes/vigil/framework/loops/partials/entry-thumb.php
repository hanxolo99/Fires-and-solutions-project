	...
	if( array_key_exists('show-featured-image', $post_meta) ):
		...
		elseif( $format === "audio" ) :
			if( has_post_thumbnail() ) : ?>
				<a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s','vigil'),the_title_attribute('echo=0'));?>"><?php the_post_thumbnail("full", array( 'class' => 'animate', 'data-animate' => 'fadeIn' ));?></a><?php
			endif;
