...
VIGIL_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => __( 'Site Skin', 'vigil' ),
	'priority' => 23
) );
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Predefined Skin ?', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 1,
		'default'  => vigil_defaults('use-predefined-skin' ),
		'choices'  => array(
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Skin', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'default' => vigil_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Primary Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			# Primary Color - Base	
			array( 'element' => 'a, h1 a:hover, h2 a:hover, h3 a:hover, h4 a:hover, h5 a:hover, h6 a:hover, #footer a:hover', 'property' => 'color' ),
...
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-icon-box.type1 .icon-content h4:before, .dt-sc-icon-box.type3.dt-sc-diamond:hover .icon-wrapper:after, .dt-sc-icon-box.type5.rounded-skin .icon-wrapper, .dt-sc-icon-box.type5.rounded:hover .icon-wrapper, .dt-sc-icon-box.type5:hover .icon-wrapper:before, .dt-sc-icon-box.type5.alter .icon-wrapper:before, .dt-sc-icon-box.type6 .icon-wrapper, .dt-sc-icon-box.type7 .icon-wrapper span, .dt-sc-contact-info.type8:hover span, .dt-sc-icon-box.type10:hover .icon-wrapper:before, .dt-sc-icon-box.type10 .icon-content h4:before, .dt-sc-icon-box.type11:before, .dt-sc-icon-box.type12, .dt-sc-icon-box.type13:hover, .dt-sc-icon-box.type14:hover, .dt-sc-icon-box.type3 .icon-content h4:before, .dt-sc-icon-box.type4 .icon-content h4:after, .custom-arrow-nav button.slick-arrow:hover i:before, .dt-sc-image-caption:hover .dt-sc-image-content a.dt-sc-button, .dt-sc-icon-box.type3:hover .icon-wrapper span', 'property' => 'background-color' ),

			# Primary BG Color - Testimonials
			array( 'element' => '.dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a:hover, .dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a.active, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a', 'property' => 'background-color' ),
			...
			array( 'element' => '.menu-active-highlight-with-arrow #main-menu > ul.menu > li.current_page_item > a:before, .menu-active-highlight-with-arrow #main-menu > ul.menu > li.current_page_ancestor > a:before, .menu-active-highlight-with-arrow #main-menu > ul.menu > li.current-menu-item > a:before, .menu-active-highlight-with-arrow #main-menu > ul.menu > li.current-menu-ancestor > a:before, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(odd):hover > a:after, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(odd):hover > .nolink-menu:after, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li.current-menu-ancestor:nth-child(odd) > a:after, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li.current-menu-ancestor:nth-child(odd) > .nolink-menu:after, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a.current', 'property' => 'border-top-color' ),
			...
			array( 'element' => '.dt-sc-up-arrow:before, .dt-sc-image-caption .dt-sc-image-wrapper .icon-wrapper:before, .dt-sc-triangle-wrapper.alter:hover .dt-sc-triangle-content:before, .dt-sc-content-with-hexagon-shape:before, .dt-sc-tabs-horizontal-frame-container.type4 ul.dt-sc-tabs-horizontal-frame > li > a.current', 'property' => 'border-bottom-color' ),
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Secondary Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Tertiary Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('body-bg-color'),
	));
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Content Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'body' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('body-content-color'),
	));
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('body-a-color'),
	));
	...
	VIGIL_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Hover Color', 'vigil' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a:hover' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => vigil_defaults('body-a-hover-color'),
	));					